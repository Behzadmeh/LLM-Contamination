...
for myseed in seeds:
    ...
    roundName = f'Gpt4_t1_Llama13b_Seed{myseed}'
    ...
    for myrow in range(df.shape[0]):
        ...
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'GPT4_res_temp1_2'] }) {df.loc[df.shape[0]-1, 'chatGPT_res_temp1_2_text'] } "
        
        #third
        df.loc[df.shape[0]]= df.iloc[myrow]
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'GPT4_res_t1_3'] }) {df.loc[df.shape[0]-1, 'GPT4_res_t1_3_text'] } "
        #forth
        df.loc[df.shape[0]]= df.iloc[myrow]
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'GPT4_res_t1_4'] }) {df.loc[df.shape[0]-1, 'GPT4_res_t1_4_text'] } "
        #fifth
        df.loc[df.shape[0]]= df.iloc[myrow]
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'GPT4_res_t1_5'] }) {df.loc[df.shape[0]-1, 'GPT4_res_t1_5_text'] } "
