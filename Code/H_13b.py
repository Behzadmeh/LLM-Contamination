...
for myseed in seeds:
    ...
    roundName = f'Human_Llama13b_Seed{myseed}'
    ...
    for myrow in range(df.shape[0]):
        ...
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'hu2'] }) {df.loc[df.shape[0]-1, 'h2_text'] } "
        
        #third
        df.loc[df.shape[0]]= df.iloc[myrow]
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'hu3'] }) {df.loc[df.shape[0]-1, 'h3_text'] } "
        #forth
        df.loc[df.shape[0]]= df.iloc[myrow]
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'hu4'] }) {df.loc[df.shape[0]-1, 'h4_text'] } "
        #fifth
        df.loc[df.shape[0]]= df.iloc[myrow]
        df.loc[df.shape[0]-1, 'full_question'] = f"Question: {df.loc[df.shape[0]-1, 'stem']} (A) {df.loc[df.shape[0]-1, 'AA'] } (B) {df.loc[df.shape[0]-1, 'BB'] } (C) {df.loc[df.shape[0]-1, 'CC'] } (D) {df.loc[df.shape[0]-1, 'DD'] }. \nThe correct response is: ({df.loc[df.shape[0]-1, 'hu5'] }) {df.loc[df.shape[0]-1, 'h5_text'] } "
